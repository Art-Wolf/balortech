            ...
            <div class="nav-menu">
               ...
               <div class="tab-content">
                  ...
                  <div class="tab-pane" id="tab2">
                     ...
                     <div class="row-fluid clearfix">
                        <div class="span8">
                           ...
                           <blockquote>
                              <p>Donec ac purus nec diam laoreet sollicitudin. Fusce ullamcorper imperdiet turpis.</p>
                              <small>George Harrison</small> 
                           </blockquote>
                        </div>
                        <div class="span4"> Duis vitae risus mauris, ut pharetra elit. Donec a purus augue. Vestibulum ultrices augue ac sapien convallis ultrices. </div>
                     </div>
                     <!-- end of example content --> 
                  </div>
                  <div class="tab-pane" id="tab3">
                     <!-- example content --> 
                     <div class="row-fluid clearfix">
                        <div class="span2"> <a href="images/maps.png" class="thumbnail fancybox"><img src="images/maps.png"></a> </div>
                        <div class="span2">
